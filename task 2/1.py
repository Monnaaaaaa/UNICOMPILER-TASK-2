...
check=IntVar()
videoradioButton =Radiobutton(innerframe,image=radioImage,text ='Single Video',compound=LEFT,font=('arial black',8,'bold'),relief=SOLID,variable=check,value=1) 
...
check1=IntVar()
lr_button= Radiobutton(innerframe,text='Low Resolution',font=('arial',10,BOLD),relief=SOLID, variable=check1,value=3,height=2)
lr_button.grid(row=1,column=0, padx=20,pady=20)


#High resolution button
lr_button= Radiobutton(innerframe,text='High Resolution',font=('arial',10,BOLD),relief=SOLID, variable=check1,value=4,height=2)
lr_button.grid(row=1,column=1, padx=10,pady=10)
